! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("Typewriter", [], t) : "object" == typeof exports ? exports.Typewriter = t() : e.Typewriter = t() }(window, function() {
    return function(e) {
        var t = {};
        ...
        (function(t) {
            for (var r = n(3), o = "undefined" == typeof window ? t : window, a = ["moz", "webkit"], i = "AnimationFrame", s = o["request" + i], u = o["cancel" + i] || o["cancelRequest" + i], c = 0; !s && c < a.length; c++) s = o[a[c] + "Request" + i], u = o[a[c] + "Cancel" + i] || o[a[c] + "CancelRequest" + i];
            if (!s || !u) {
                var l = 0,
                    p = 0,
                    d = [];
        ...
        var r = n(0),
            o = n.n(r),
            a = function(e) { return new RegExp(/<[a-z][\s\S]*>/i).test(e) },
            ...
            function e(t, n) {
                ...
                if (function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), f(this, "state", { cursorAnimation: null, lastFrameTime: null, pauseUntil: null, eventQueue: [], eventLoop: null, eventLoopPaused: !1, reverseCalledEvents: [], calledEvents: [], visibleNodes: [], initialOptions: null, elements: { container: null, wrapper: document.createElement("span"), cursor: document.createElement("span") } }), f(this, "options", { strings: null, cursor: "|", delay: "natural", deleteSpeed: "natural", loop: !1, autoStart: !1, devMode: !1, skipAddStyles: !1, wrapperClassName: "Typewriter__wrapper", cursorClassName: "Typewriter__cursor" }), f(this, "setupWrapperElement", function() { u.state.elements.wrapper.className = u.options.wrapperClassName, u.state.elements.cursor.className = u.options.cursorClassName, u.state.elements.cursor.innerHTML = u.options.cursor, u.state.elements.container.innerHTML = "", u.state.elements.container.appendChild(u.state.elements.wrapper), u.state.elements.container.appendChild(u.state.elements.cursor) }), f(this, "start", function() { return u.state.eventLoopPaused = !1, u.runEventLoop(), u }), f(this, "pause", function() { return u.state.eventLoopPaused = !0, u }), f(this, "stop", function() { return u.state.eventLoop && (Object(r.cancel)(u.state.eventLoop), u.state.eventLoop = null), u }), f(this, "pauseFor", function(e) { return u.addEventToQueue(c.PAUSE_FOR, { ms: e }), u }), f(this, "typeOutAllStrings", function() { return "string" == typeof u.options.strings ? (u.typeString(u.options.strings).pauseFor(1500), u) : (u.options.strings.forEach(function(e) { u.typeString(e).pauseFor(1500).deleteAll() }), u) }), f(this, "typeString", function(e) { var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null; return a(e) ? u.typeOutHTMLString(e, t) : (e && u.typeCharacters(e.split(""), t), u) }), f(this, "typeOutHTMLString", function(e) {
                        ...
                        if (!u.state.eventQueue.length) {
                            ...
                            u.state.eventQueue = d(u.state.calledEvents), u.state.calledEvents = [], u.options = p({}, u.state.initialOptions), u.addEventToQueue(c.REMOVE_ALL, null, !0), u.addEventToQueue(c.CHANGE_CURSOR, { cursor: u.options.cursor }, !0)
                        }
                        if (u.state.eventLoop = o()(u.runEventLoop), !u.state.eventLoopPaused) {
                            ...
                            var n = d(u.state.eventQueue),
                                r = n.shift(),
                                a = 0;
                            if (!(t <= (a = r.eventName === c.REMOVE_LAST_VISIBLE_NODE || r.eventName === c.REMOVE_CHARACTER ? "natural" === u.options.deleteSpeed ? s(40, 80) : u.options.deleteSpeed : "natural" === u.options.delay ? s(120, 160) : u.options.delay))) {
                                var i = r.eventName,
                                    E = r.eventArgs;
                                switch (u.logInDevMode({ currentEvent: r, state: u.state, delay: a }), i) {
                                    case c.TYPE_CHARACTER:
                                        var f = E.character,
                                            v = E.node,
                                            h = document.createTextNode(f);
                                        v ? v.appendChild(h) : u.state.elements.wrapper.appendChild(h), u.state.visibleNodes = [].concat(d(u.state.visibleNodes), [{ type: l.TEXT_NODE, node: h }]);
                                        break;
                                    case c.REMOVE_CHARACTER:
                                        n.unshift({ eventName: c.REMOVE_LAST_VISIBLE_NODE, eventArgs: { removingCharacterNode: !0 } });
                                        break;
                                    case c.PAUSE_FOR:
                                        var T = r.eventArgs.ms;
                                        u.state.pauseUntil = Date.now() + parseInt(T);
                                        break;
                                    case c.CALL_FUNCTION:
                                        var m = r.eventArgs,
                                            _ = m.cb,
                                            y = m.thisArg;
                                        _.call(y, { elements: u.state.elements });
                                        break;
                                    case c.ADD_HTML_TAG_ELEMENT:
                                        var A = r.eventArgs,
                                            w = A.node,
                                            g = A.parentNode;
                                        g ? g.appendChild(w) : u.state.elements.wrapper.appendChild(w), u.state.visibleNodes = [].concat(d(u.state.visibleNodes), [{ type: l.HTML_TAG, node: w, parentNode: g || u.state.elements.wrapper }]);
                                        break;
                                    case c.REMOVE_ALL:
                                        var L = u.state.visibleNodes,
                                            C = E.speed,
                                            N = [];
                                        C && N.push({ eventName: c.CHANGE_DELETE_SPEED, eventArgs: { speed: C } });
                                        for (var b = 0, O = L.length; b < O; b++) N.push({ eventName: c.REMOVE_LAST_VISIBLE_NODE, eventArgs: { removingCharacterNode: !1 } });
                                        C && N.push({ eventName: c.CHANGE_DELETE_SPEED, eventArgs: { speed: u.options.deleteSpeed } }), n.unshift.apply(n, N);
                                        break;
                                    case c.REMOVE_LAST_VISIBLE_NODE:
                                        var S = r.eventArgs.removingCharacterNode;
                                        if (u.state.visibleNodes.length) {
                                            var R = u.state.visibleNodes.pop(),
                                                M = R.type,
                                                D = R.node;
                                            D.parentNode.removeChild(D), M === l.HTML_TAG && S && n.unshift({ eventName: c.REMOVE_LAST_VISIBLE_NODE, eventArgs: {} })
                                        }
                                        break;
                                    case c.CHANGE_DELETE_SPEED:
                                        u.options.deleteSpeed = r.eventArgs.speed;
                                        break;
                                    case c.CHANGE_DELAY:
                                        u.options.delay = r.eventArgs.delay;
                                        break;
                                    case c.CHANGE_CURSOR:
                                        u.options.cursor = r.eventArgs.cursor, u.state.elements.cursor.innerHTML = r.eventArgs.cursor
                                }
                                u.options.loop && r.eventName !== c.REMOVE_ALL && r.eventName !== c.REMOVE_CHARACTER && (u.state.calledEvents = [].concat(d(u.state.calledEvents), [r])), u.state.eventQueue = n, u.state.lastFrameTime = e
                            }
                        }
                ...
                n && (this.options = p({}, this.options, n)), this.state.initialOptions = p({}, this.options), this.init()
            }
            var t, n, v;
            return t = e, (n = [{ key: "init", value: function() { this.setupWrapperElement(), window.___TYPEWRITER_JS_STYLES_ADDED___ || this.options.skipAddStyles || (u(".Typewriter__cursor{-webkit-animation:Typewriter-cursor 1s infinite;animation:Typewriter-cursor 1s infinite;margin-left:1px}@-webkit-keyframes Typewriter-cursor{0%{opacity:0}50%{opacity:1}100%{opacity:0}}@keyframes Typewriter-cursor{0%{opacity:0}50%{opacity:1}100%{opacity:0}}"), window.___TYPEWRITER_JS_STYLES_ADDED___ = !0), !0 === this.options.autoStart && this.options.strings && this.typeOutAllStrings().start() } }, { key: "logInDevMode", value: function(e) { this.options.devMode && console.log(e) } }]) && E(t.prototype, n), v && E(t, v), e
        }();
        ...
        function s(e) { if (n === setTimeout) return setTimeout(e, 0); if ((n === a || !n) && setTimeout) return n = setTimeout, setTimeout(e, 0); try { return n(e, 0) } catch (t) { try { return n.call(null, e, 0) } catch (t) { return n.call(this, e, 0) } } }! function() { try { n = "function" == typeof setTimeout ? setTimeout : a } catch (e) { n = a } try { r = "function" == typeof clearTimeout ? clearTimeout : i } catch (e) { r = i } }();
        var u, c = [],
            l = !1,
            p = -1;

        function d() { l && u && (l = !1, u.length ? c = u.concat(c) : p = -1, c.length && E()) }
        ...
        o.nextTick = function(e) {
            ...
            c.push(new f(e, t)), 1 !== c.length || l || s(E)
